        ...
        <div class="modal-body">
            <form action="{{ route ('changepass') }}" method="POST" id="form-change-password">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" name="currentpassword" id="currentpassword" aria-describedby="Current Password">
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">New Password</label>
                  <input type="password" class="form-control" name="newpassword" id="newpassword" aria-describedby="New Password">
                </div>
            </form>
        </div>
